...
resource "google_storage_bucket_iam_member" "unscanned_file_uploads" {
  bucket = data.terraform_remote_state.backends.outputs.app_data_buckets.manufacturer_portal_uploads_unscanned_id
