...
public interface IUnitOfWork
{
    ...
    /// </summary>
    /// <returns>A task that represents the asynchronous transaction operation. The task result contains an object that represents the new database transaction.</returns>
