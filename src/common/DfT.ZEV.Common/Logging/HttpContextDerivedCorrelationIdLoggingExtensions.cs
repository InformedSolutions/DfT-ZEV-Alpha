...
/// </summary>
public static class HttpContextDerivedCorrelationIdLoggingExtensions
{
    /// <summary>
    ...
    public static LoggerConfiguration WithCorrelationIdLogging(this LoggerEnrichmentConfiguration enrichmentConfiguration)
    {
        ...
        return enrichmentConfiguration.With<HttpContextDerivedCorrelationIdEnricher>();
    }
}
