...
public static class BuildIdLoggingExtensions
{
    ...
    public static LoggerConfiguration WithBuildIdLogging(this LoggerEnrichmentConfiguration enrichmentConfiguration)
    {
        ...
        return enrichmentConfiguration.With<BuildIdLoggingEnricher>();
    }
}